    ...
    return Scaffold(
      ...
      slivers: [
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          if (Following.contains(
                                            ...
                                            SizedBox(width: 10,),
                                          if (snapshotUserInfo.data['userType'] == "Coach")
                                            ElevatedButton.icon(
                                              onPressed: () {},
                                              icon: Icon(
                                                Icons.timelapse,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: MediaQuery.of(context).size.width * 50 /100,),
                                          FutureBuilder(
                ...
                actions: [
                  if (snapshotUserInfo.data['userId'] !=
                    ...
                    IconButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => Chat(UID:snapshotUserInfo.data['userId'] ,DisplayName: snapshotUserInfo.data['firstName'] +" " + snapshotUserInfo.data['lastName'],ImageUrl: snapshotUserInfo.data['imageUrl'],UserBio: snapshotUserInfo.data['bio'], ),));
                        }),
                  /* IconButton(
                  icon: Icon(
                    Icons.logout,
        ...
        SliverList(
          ...
          // TimelineBuilder(future: Provider.of<PostProvider>(context,listen: false).fetchPostsData(),),
        ]))
      ],
    ));
  }
